...
class JikanAnimeVideos {
  ...
  static JikanAnimeVideos fromRawJson(String str) =>
      JikanAnimeVideos.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory JikanAnimeVideos.fromJson(Map<String, dynamic> json) =>
      JikanAnimeVideos(
        ...
        promo: json["promo"] == null
            ? null
            : List<PromoVideo>.from(
                json["promo"].map((x) => PromoVideo.fromJson(x))),
        episodes: json["episodes"] == null
            ? null
            : List<EpisodeVideo>.from(
                json["episodes"].map((x) => EpisodeVideo.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "promo": promo == null
            ? null
            : List<dynamic>.from(promo.map((x) => x.toJson())),
