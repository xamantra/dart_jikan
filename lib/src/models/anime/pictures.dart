...
class JikanAnimePictures {
  ...
  static JikanAnimePictures fromRawJson(String str) =>
      JikanAnimePictures.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory JikanAnimePictures.fromJson(Map<String, dynamic> json) =>
      JikanAnimePictures(
