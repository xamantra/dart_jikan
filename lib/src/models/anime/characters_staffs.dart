...
class JikanAnimeCharacterStaff {
  ...
  static JikanAnimeCharacterStaff fromRawJson(String str) =>
      JikanAnimeCharacterStaff.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory JikanAnimeCharacterStaff.fromJson(Map<String, dynamic> json) =>
      JikanAnimeCharacterStaff(
        ...
        staff: json["staff"] == null
            ? null
            : List<Person>.from(json["staff"].map((x) => Person.fromJson(x))),
      );
